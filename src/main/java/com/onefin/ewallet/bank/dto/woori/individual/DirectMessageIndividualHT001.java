...
import com.onefin.ewallet.bank.dto.woori.DirectMessageCommon;
import com.onefin.ewallet.common.base.anotation.MinMaxFieldLengthConstraint;
import lombok.Data;

@Data
public class DirectMessageIndividualHT001 extends DirectMessageCommon {
	...
	@MinMaxFieldLengthConstraint(maxLength = 189)
